...
# 5
print("Anna has {} apples and {} peaches".format(10, 3))

# 6
print("Anna has {0} apples and {1} peaches".format(5, 5))

# 7
print("Anna has {apl} apples and {pchs} peaches".format(apl=4, pchs=10))

# 8
print("Anna has {apl} apples and {pchs} peaches".format(apl="_" * 5, pchs="_" * 3))
...
# 10
print("Anna has %s apples" % b)

# 11
my_dict = {'apple': '3', "peach": '5'}
print("Anna has {m[apple]} apples and {m[peach]} peaches".format(m=my_dict))
